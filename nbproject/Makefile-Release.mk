...
${OBJECTDIR}/DAOs/UserDAO.o: DAOs/UserDAO.cpp 
	${MKDIR} -p ${OBJECTDIR}/DAOs
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DAOs/UserDAO.o DAOs/UserDAO.cpp
...
${OBJECTDIR}/Models/User.o: Models/User.cpp 
	${MKDIR} -p ${OBJECTDIR}/Models
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Models/User.o Models/User.cpp
...
${OBJECTDIR}/sys/Semaphore.o: sys/Semaphore.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sys/Semaphore.o sys/Semaphore.cpp

${OBJECTDIR}/sys/ThreadPool.o: sys/ThreadPool.cpp 
	${MKDIR} -p ${OBJECTDIR}/sys
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sys/ThreadPool.o sys/ThreadPool.cpp
